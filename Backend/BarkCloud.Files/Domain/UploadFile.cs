...
public class UploadFile
{
    ...
    /// и на не-Apple устройствах. Заполняется при загрузке для изображений, оригинал
    /// которых не является браузеро-дружелюбным JPEG (HEIC/PNG/WebP/…); для оригинала-JPEG
    /// указывает на сам файл. null — у видео/документов и легаси-файлов до миграции.
    /// Оригинал всегда сохраняется как есть (доступен для скачивания).
    /// </summary>
