...
namespace BarkCloud.Files.Persistence.Migrations
{
    ...
    [Migration("20260913233127_PersistUploadSessionParts")]
    partial class PersistUploadSessionParts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarkCloud.Files.Domain.AlbumShareLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerId", "AlbumId")
                        .IsUnique();

                    b.HasIndex("OwnerId", "CreatedAt");

                    b.ToTable("AlbumShareLinks");
                });
            ...
            modelBuilder.Entity("BarkCloud.Files.Domain.FileActivityEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerId", "FileId", "CreatedAt");
            ...
            modelBuilder.Entity("BarkCloud.Files.Domain.FileSearchAlias", b =>
                {
                    ...
                    b.ToTable("FileSearchAliases");
                });

            modelBuilder.Entity("BarkCloud.Files.Domain.FileTag", b =>
                {
                    b.Property<long>("OwnerId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("OwnerId", "FileId", "NormalizedValue");
            ...
            modelBuilder.Entity("BarkCloud.Files.Domain.UploadFile", b =>
                {
                    ...
                    b.Property<Guid?>("JpegViewFileId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BarkCloud.Files.Domain.UploadSessionPart", b =>
                {
                    ...
                    b.HasKey("SessionId", "PartNumber");

                    b.HasIndex("SessionId", "UpdatedAt");

                    b.ToTable("UploadSessionParts");
                });
            ...
            modelBuilder.Entity("BarkCloud.Files.Domain.UploadSessionPart", b =>
                {
                    b.HasOne("BarkCloud.Files.Domain.UploadSession", null)
                        .WithMany()
