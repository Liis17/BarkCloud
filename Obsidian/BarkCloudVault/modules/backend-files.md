...
- `IMultipartUploadStore.cs` / `S3MultipartUploadStore.cs` — Files-owned V2 multipart seam: initiate/upload/list/complete/abort/head; R2-части используют unsigned payload
