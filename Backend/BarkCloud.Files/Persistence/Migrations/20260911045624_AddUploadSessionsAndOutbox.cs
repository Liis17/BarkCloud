...
{
    /// <inheritdoc />
    public partial class AddUploadSessionsAndOutbox : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageProfileId = table.Column<string>(type: "text", nullable: false),
                    MultipartUploadId = table.Column<string>(type: "text", nullable: false),
                    PartSize = table.Column<long>(type: "bigint", nullable: false),
                    UploadTokenHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ReservedBytes = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastActivityAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CompletedEtag = table.Column<string>(type: "text", nullable: true),
                    LegacyProcessingCompletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UploadSessions_OwnerId_IdempotencyKey",
                table: "UploadSessions",
