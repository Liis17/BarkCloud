...
public final class CloudRepository: Sendable {
    let grpc: GrpcManager
    public let transfer: FileTransferService
    ...
    public func deleteUserMedia(fileID: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func checkFileHashes(_ hashes: [String]) async throws -> [String: Bool] {
    ...
    public func checkFileHash(_ hash: String) async throws -> String? {
        let stub = try await grpc.filesStub()
    ...
    public func getFileMetadata(fileID: String) async throws -> CloudFileMetadata? {
        let stub = try await grpc.filesStub()
    ...
    public func createShare(fileID: String, name: String) async throws -> ShareLink {
        let stub = try await grpc.cloudStub()
    ...
    public func shareFileWithUser(fileID: String, recipientUserID: Int64) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func getSharedFileDownloadUrl(fileID: String) async throws -> URL? {
        let stub = try await grpc.cloudStub()
    ...
    public func listMyOutgoingShares(fileID: String) async throws -> [OutgoingShare] {
        let stub = try await grpc.cloudStub()
    ...
    public func revokeUserShare(grantID: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func path(directoryID: String) async throws -> [PathCrumb] {
        let stub = try await grpc.cloudStub()
    ...
    @discardableResult
    public func createDirectory(parentID: String, name: String) async throws -> CloudDirectory {
        let stub = try await grpc.cloudStub()
    ...
    public func renameDirectory(_ directoryID: String, newName: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func moveDirectory(_ directoryID: String, newParentID: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func deleteDirectory(_ directoryID: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func renameFileEntry(_ entryID: String, newName: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func moveFileEntry(_ entryID: String, newDirectoryID: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func deleteFileEntry(_ entryID: String) async throws {
        let stub = try await grpc.cloudStub()
    ...
    public func deleteFromTrash(entryID: String) async throws {
        let stub = try await grpc.cloudStub()
